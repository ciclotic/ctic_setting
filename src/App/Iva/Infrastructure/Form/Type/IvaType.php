...
namespace CTIC\App\Iva\Infrastructure\Form\Type;
...
use CTIC\App\Iva\Domain\IvaInterface;
...
final class IvaType extends AbstractResourceType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ...
            ->add('equivalenceProcurement', TextType::class, [
